...
def evens_itersect_ods        : set ℕ := { n : ℕ | ev n ∧ od n    }      
def evens_complement          : set ℕ := { n : ℕ | ¬ ev n         }         
def ods_complement            : set ℕ := { n : ℕ | ¬ od n         }         
def evens_itersect_empte      : set ℕ := { n : ℕ | ev n ∧  false  }  
def evens_itersect_complete   : set ℕ := { n : ℕ | ev n ∧  true   }   
def evens_union_empty         : set ℕ := { n : ℕ                  }
