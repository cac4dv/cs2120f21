...
/-
The proposition true is unconditionally
true, as proven by an always available
proof called (in Lean) true.intro.
-/
...
-//- lemma and theorems are interchangeable -/ 
...
Give proof of P and a proof of Q
...
/-
Prove that if arbitary propositions P ∧ Q
are true (which is to say that we have a
proof of each of them), that the
proposition P ⟧and Q is also true.theorem
